...
Pune $\cdot$ 
swarnim335@gmail.com $\cdot$ 
8149833469 $\cdot$ 
\href{https://github.com/swarnimcodes/}{GitHub} $\cdot$ % $\cdot$ \href{https://smarniw.xyz}{smarniw.xyz} \\
\href{https://linkedin.com/in/swarnimbarapatre}{LinkedIn} \\
\end{center}
...
\vspace{1mm}
\textbf{Software Engineer | AI Department | AccurateIC, Pune} \hfill Aug 2024 -- Present \\
% \textbf{Mastersoft} \hfill Nagpur\\
% \textit{Software Development Engineer, R\&D Department} \hfill Aug 2023 - June 2024\\
% \vspace{-1mm}
\begin{itemize}

    \item Enhanced the system architecture and co-developed software for an Autonomous Ship,
    to be delivered to the \textbf{Indian Navy}.
    \item Reduced CPU consumption by \textbf{70\%} by identifying and re-writing inefficient code.
    \item Proposed and implemented synchronized communication between the Ship and the Control Base.
    \item Built backend services, including APIs, database development, authentication, etc for multiple projects. 
    \item Worked as a full-stack developer while using technologies such as React, Express,
    PostgreSQL, SQLite, Tailwind, Vite, etc.

\end{itemize}

\textbf{Software Engineer | R\&D Department | Mastersoft, Nagpur} \hfill Aug 2023 -- Jun 2024 \\
% \textbf{Mastersoft} \hfill Nagpur\\
% \textit{Software Development Engineer, R\&D Department} \hfill Aug 2023 - June 2024\\
% \vspace{-1mm}
\begin{itemize}
...
\textbf{Programming Languages:} & JavaScript, TypeScript, Python, Go, Powershell, Bash, C, Pascal \\

\textbf{Web Frameworks:} & React, Express, Flask, FastAPI, Echo, Gin \\
\textbf{Databases:} & PostgreSQL, SQLite, Microsoft SQL, MongoDB \\

\textbf{Tools/Technologies:} & Linux, Emacs, Vim, Git, Nginx, \LaTeX{}, WebSockets \\
...
\begin{itemize} 
    ...
    \item Implemented persistence as well as optional parallel queue processing. \\
\end{itemize}
...
\href{https://github.com/swarnimcodes/openai-gen-co-and-qp}{OpenAI APIs},
...
\textbf{Swimming}: National Swimmer. Multiple times State Gold Medalist.
